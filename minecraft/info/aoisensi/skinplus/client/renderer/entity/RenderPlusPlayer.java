...
public class RenderPlusPlayer extends RenderPlayer
{
	...
	{
		super();
		ModelPlusBiped modelPlusBiped = new ModelPlusBiped();
		try {
			Field nameField1 = RenderPlayer.class.getDeclaredField("modelBipedMain");
			nameField1.setAccessible(true);
			nameField1.set(this, modelPlusBiped);
			Field nameField2 = RenderLiving.class.getDeclaredField("mainModel");
			nameField2.setAccessible(true);
			nameField2.set(this, modelPlusBiped);
...
//        this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelPlusBipedMain.heldItemRight = itemstack != null ? 1 : 0;
//
...
//            {
//                this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelPlusBipedMain.heldItemRight = 3;
//            }
//            else if (enumaction == EnumAction.bow)
//            {
//                this.modelArmorChestplate.aimedBow = this.modelArmor.aimedBow = this.modelPlusBipedMain.aimedBow = true;
//            }
//        }
//
//        this.modelArmorChestplate.isSneak = this.modelArmor.isSneak = this.modelPlusBipedMain.isSneak = par1EntityPlayer.isSneaking();
...
//        this.modelArmorChestplate.aimedBow = this.modelArmor.aimedBow = this.modelPlusBipedMain.aimedBow = false;
//        this.modelArmorChestplate.isSneak = this.modelArmor.isSneak = this.modelPlusBipedMain.isSneak = false;
//        this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelPlusBipedMain.heldItemRight = 0;
//    }
//
//    /**
...
//        {
//            GL11.glPushMatrix();
//            this.modelPlusBipedMain.bipedHead.postRender(0.0625F);
//            float f2;
//
...
//                this.modelPlusBipedMain.renderEars(0.0625F);
//                GL11.glPopMatrix();
//            }
//        }
//
...
//            this.modelPlusBipedMain.renderCloak(0.0625F);
//            GL11.glPopMatrix();
//        }
//
...
//        {
//            GL11.glPushMatrix();
//            this.modelPlusBipedMain.bipedRightArm.postRender(0.0625F);
...
//        this.modelPlusBipedMain.onGround = 0.0F;
//        this.modelPlusBipedMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, par1EntityPlayer);
//        this.modelPlusBipedMain.bipedRightArm.render(0.0625F);
//    }
//
//    /**
